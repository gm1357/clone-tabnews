...
describe("infra/email.js", () => {
  test("send()", async () => {
    await email.send({
      from: "Test <test@clonetab.com.br>",
      to: "contact@clonetab.com.br",
    ...
    expect(lastEmail.sender).toEqual("<test@clonetab.com.br>");
    expect(lastEmail.recipients[0]).toEqual("<contact@clonetab.com.br>");
